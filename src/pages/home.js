    ...
    return (
        <>
            ...
            <section className="container landing">
                <div className="row">
                    <div className="col-lg-6 left">
                        ...
                        <a href="/" className="link">View Projects</a>
                        &nbsp;&nbsp;or&nbsp;&nbsp;
                        <a href="/" className="link">Download CV</a>
                    </div>

                    <div className="col-lg-6 right">
                        <img src={require("../assets/images/logo-circle-06.png")} alt="" className="imageRot" />
                    </div>
                </div>
            </section>
            ...
            <section className="container projects">
                ...
                <div className="row pt-4" id="worksCard">
                </div>
            </section>
        </>
    )
